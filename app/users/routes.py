...
def account():
	...
	return render_template('accounts/account.html', title='Account', image_file=image_file, form=form)
...
def user_posts(username):
	...
	return render_template('accounts/user_posts.html', user=user, posts=posts)
